...
module id_rn(
    ...
    input [4:0] reg1_raddr_port0_i,             // 读通用寄存器1地址
    input [4:0] reg1_raddr_port1_i,             // 读通用寄存器1地址
    input [4:0] reg2_raddr_port0_i,             // 读通用寄存器2地址
    input [4:0] reg2_raddr_port1_i,             // 读通用寄存器2地址
    ...
    output reg [4:0] reg1_raddr_port0_o,             // 读通用寄存器1地址
    output reg [4:0] reg1_raddr_port1_o,             // 读通用寄存器1地址
    output reg [4:0] reg2_raddr_port0_o,             // 读通用寄存器2地址
    output reg [4:0] reg2_raddr_port1_o,             // 读通用寄存器2地址
...
always @(posedge clk) begin
    if (!stall_flag_i) begin
        ...
        reg1_raddr_port0_o <= reg1_raddr_port0_i;
        reg1_raddr_port1_o <= reg1_raddr_port1_i;
        reg2_raddr_port0_o <= reg2_raddr_port0_i;
        reg2_raddr_port1_o <= reg2_raddr_port1_i;
